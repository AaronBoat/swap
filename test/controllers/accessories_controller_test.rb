...
class AccessoriesControllerTest < ActionController::TestCase
  ...
  test "should create accessory" do
    assert_difference('Accessory.count') do
      post :create, accessory: { description: @accessory.description, item: @accessory.item, platform: @accessory.platform, price: @accessory.price, stock: @accessory.stock }
    end
  ...
  test "should update accessory" do
    patch :update, id: @accessory, accessory: { description: @accessory.description, item: @accessory.item, platform: @accessory.platform, price: @accessory.price, stock: @accessory.stock }
    assert_redirected_to accessory_path(assigns(:accessory))
  end
